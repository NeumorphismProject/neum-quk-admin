module.exports = {
  ...
  rules: {
    ...
    'no-unused-vars': 0,
    '@typescript-eslint/no-unused-vars': 0, // 是否允许保留未使用的变量
    '@typescript-eslint/no-explicit-any': 0, // 是否允许 any 声明
    'arrow-body-style': 0, // 是否允许尖头函数中只有一行且带{}
    '@typescript-eslint/naming-convention': 1, // 驼峰命名
    'react/no-multi-comp': 0,
    'react/require-default-props': 0, // 组件默认 props 是否使用 .defaultProps 来声明
