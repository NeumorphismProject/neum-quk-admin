 ...
 * @returns boolean
 */
export const isArray = (val: string) => Object.prototype.toString.call(val) === '[object Array]';
 ...
 * @returns boolean
 */
export const isObject = (val: string) => typeof val === 'object';
 ...
 * @param {Number} val
 */
export const checkNum = (val: string) => /^\d{1,}$/g.test(val);

/**
 *  判断是否是字母
 * @param {Number} val
 */
export const checkLetter = (val: string) => /^[a-zA-Z]+$/g.test(val);

/**
 * 判断是否是字母或数字
 * @param {Number || String} val  字符或数字
 */
export const checkNumOrLetter = (val: string) => /^[0-9a-zA-Z]*$/g.test(val);

/**
 * 判断是否是中文
 * @param {String} data  中文
 */
export const checkChinese = (val: string) => /^[\u4E00-\u9FA5]+$/g.test(val);
 ...
 * @param {String} val
 */
export const checkTelphone = (val: string) => {
 ...
 * @param {Object} val 值
 */
export const localStorageSet = (key: string, val: any) => {
